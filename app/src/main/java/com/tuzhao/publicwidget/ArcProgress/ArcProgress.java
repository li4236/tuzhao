package com.tuzhao.publicwidget.ArcProgress;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        min_size = (int) DensityUtil.dp2px(context, 100);
        default_text_size = DensityUtil.sp2px(context, 40);
        default_suffix_text_size = DensityUtil.sp2px(context, 15);
        default_suffix_padding = DensityUtil.dp2px(context, 4);
        default_suffix_text = "";
        default_bottom_text_size = DensityUtil.sp2px(context, 10);
        default_stroke_width = DensityUtil.dp2px(context, 4);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = String.valueOf(getProgress())+"/"+getMax();
        ...
        if (!TextUtils.isEmpty(getBottomText())) {
            Log.e("TAG",getBottomText());
            textPaint.setTextSize(bottomTextSize);
            textPaint.setFakeBoldText(true);
            float bottomTextBaseline = getHeight() - arcBottomHeight+DensityUtil.dp2px(mContext, 6) - (textPaint.descent() + textPaint.ascent()) / 2;
