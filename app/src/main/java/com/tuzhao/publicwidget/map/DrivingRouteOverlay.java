...
//        mPolylineOptionscolor.add(AMapUtil.convertToLatLng(tmcSection.get(0).getPolyline().get(0)));
        ...
        points.add(new LatLng(tmcSection.get(0).getPolyline().get(0).getLatitude(),tmcSection.get(0).getPolyline().get(0).getLongitude()));
...
//				mPolylineOptionscolor.add(AMapUtil.convertToLatLng(mployline.get(j)));
                points.add(new LatLng(mployline.get(j).getLatitude(),mployline.get(j).getLongitude()));
...
//        } else
    ...
    private BitmapDescriptor getThroughPointBitDes() {
        return BitmapDescriptorFactory.fromResource(R.mipmap.ic_youhuixuanze);
