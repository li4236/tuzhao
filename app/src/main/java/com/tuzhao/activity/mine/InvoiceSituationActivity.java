...
public class InvoiceSituationActivity extends BaseRefreshActivity<InvoiceSituation> {
    ...
    @Override
    protected void bindData(BaseViewHolder holder, InvoiceSituation invoiceSituation, int position) {
        holder.setText(R.id.invoice_progress_company_item, invoiceSituation.getCompany())
                ...
                .setText(R.id.invoice_progress_apply_item, invoiceSituation.getApplyDate())
