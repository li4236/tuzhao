...
public class CommentPsActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.id_activity_commentps_layout_imageview_add:
                //调用相册
                ImageUtil.startTakeMultiPhoto(CommentPsActivity.this,3);
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICKER && data != null) {
            img_list = data.getStringArrayListExtra(PhotoPickConfig.EXTRA_STRING_ARRAYLIST);
            initSomePic();
            file_list = new ArrayList<>();
            for (String imageBean : img_list) {
                //进行图片逐个压缩
    ...
    private void initSomePic() {
        ...
        switch (img_list.size()) {
            case 1:
                ...
                relativelayout_img2.setVisibility(View.GONE);
                relativelayout_img3.setVisibility(View.GONE);
                ImageUtil.showPic(imageview_img1, img_list.get(0), R.mipmap.ic_img);
                break;
            case 2:
                relativelayout_img1.setVisibility(View.VISIBLE);
                relativelayout_img2.setVisibility(View.VISIBLE);
                relativelayout_img3.setVisibility(View.GONE);
                ImageUtil.showPic(imageview_img2, img_list.get(1), R.mipmap.ic_img);
                break;
            case 3:
                relativelayout_img1.setVisibility(View.VISIBLE);
                relativelayout_img2.setVisibility(View.VISIBLE);
                ...
                ImageUtil.showPic(imageview_img1, img_list.get(0), R.mipmap.ic_img);
                ImageUtil.showPic(imageview_img2, img_list.get(1), R.mipmap.ic_img);
                ImageUtil.showPic(imageview_img3, img_list.get(2), R.mipmap.ic_img);
                break;
        }
    }
