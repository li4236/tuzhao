...
public class PayForOrderFragment extends BaseStatusFragment implements View.OnClickListener{
...
/*    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ConstansUtil.REQUSET_CODE && resultCode == -1 && data != null) {
