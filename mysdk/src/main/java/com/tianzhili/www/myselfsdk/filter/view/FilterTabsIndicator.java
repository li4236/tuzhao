package com.tianzhili.www.myselfsdk.filter.view;
...
public class FilterTabsIndicator extends LinearLayout {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        mTabDefaultColor = ContextCompat.getColor(context,R.color.gray);
        mTabSelectedColor = ContextCompat.getColor(context,R.color.b1);
...
//        canvas.drawRect(0, 0, measuredWidth, mLineHeight, mLinePaint);
    ...
    private View generateTextView(String title, int pos) {
        ...
        Drawable drawable = ContextCompat.getDrawable(context,R.drawable.level_filter);//设置箭头方向
