package com.tianzhili.www.myselfsdk.okgo.convert;
...
import com.tianzhili.www.myselfsdk.okgo.utils.HttpUtils;
        ...
        try {
            ...
            while ((len = is.read(buf)) != -1) {
                ...
                if (callback != null) {
                    ...
                    //每500毫秒刷新一次数据
                    if (curTime - lastRefreshUiTime >= 500 || finalSum == total) {
                        //计算下载速度
