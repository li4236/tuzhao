package com.tianzhili.www.myselfsdk.update.download;

import com.tianzhili.www.myselfsdk.update.ParseData;
...
import com.tianzhili.www.myselfsdk.update.util.HandlerUtil;
    ...
    public void run() {
        try {
            ...
            if ((parse.getVersionCode() > curVersion) &&
                    ((UpdateSP.isIgnore(parse.getVersionCode()+","+parse.getTime())
