package com.tianzhili.www.myselfsdk.circleprogress;
...
import com.tianzhili.www.myselfsdk.BuildConfig;
import com.tianzhili.www.myselfsdk.R;
import com.tianzhili.www.myselfsdk.circleprogress.utils.Constant;
import com.tianzhili.www.myselfsdk.circleprogress.utils.MiscUtil;
...
public class CircleProgress extends View {
    ...
    private int[] mGradientColors = {Color.argb(255,255,204,48), Color.argb(255,255,190,48), Color.argb(255,255,204,48)};
    //当前进度，[0.0f,1.0f]
    ...
    private void drawText(Canvas canvas) {
        ...
        if (mUnit != null) {
            Float aaa = mValuePaint.measureText(String.format(mPrecisionFormat, mValue));
            canvas.drawText(mUnit.toString(), mCenterPoint.x+(aaa/2)+35, mValueOffset-(mValueOffset/40), mUnitPaint);
        }
    }
    ...
    public void setValue(float value,long time) {
        ...
        startAnimator(start, end, time);
    }

    private void startAnimator(float start, float end, long animTime) {
        mAnimator = ValueAnimator.ofFloat(start, end).setDuration(animTime);
