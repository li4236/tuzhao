package com.tianzhili.www.myselfsdk.dashboardview.view;
...
import com.tianzhili.www.myselfsdk.dashboardview.util.PxUtils;
...
public class DashboardViewAttr {
    ...
    public DashboardViewAttr(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        unit = ta.getString(R.styleable.DashboardView_unit1);
        textColor = ta.getColor(R.styleable.DashboardView_textColor, context.getResources().getColor(R.color.text6Color));
        ...
        progressColor = ta.getColor(R.styleable.DashboardView_progressColor, context.getResources().getColor(R.color.text6Color));
        ...
        circleColor = ta.getColor(R.styleable.DashboardView_centerCircleColor, context.getResources().getColor(R.color.text6Color));
        ta.recycle();
    }
