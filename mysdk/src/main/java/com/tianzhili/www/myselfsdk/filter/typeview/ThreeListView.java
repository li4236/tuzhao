...
import com.tianzhili.www.myselfsdk.filter.adapter.BaseBaseAdapter;
import com.tianzhili.www.myselfsdk.filter.adapter.SimpleTextAdapter;
...
public class ThreeListView<FIRSTD, SECONDD, THIRDD> extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    private void init(Context context) {
        ...
        lv_third = (ListView) findViewById(R.id.lv_three);
